    ...
    <>
      <Container variant="token" marginTop={'20px'}>
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Position Health</Box>
          <Box>
            <Text
              color={
        ...
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Asset</Box>
          <Box>
            <TokenDescription token={token} />
          </Box>
        </Flex>
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Strategy</Box>
          <Box>
            <Text>{row.APY}</Text>
          </Box>
        </Flex>
        ...
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Cur. ColRatio</Box>
          <Box>
        ...
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Liq. price</Box>
          <Box>
        ...
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Collateral</Box>
          <Box>
        ...
        <Flex flexDirection={'row'} justifyContent={'space-between'} p={'4'}>
          <Box color={'whiteAlpha.400'}>Debt</Box>
          <Box>
            <Text>{row.debt}</Text>
          </Box>
        </Flex>
